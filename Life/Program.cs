...
namespace cli_life
{
    ...
    public class Program
    {
        ...
        {
            //string path = "";
            //Props props = JsonSerializer.Deserialize<Data>(File.ReadAllText(path));
        ...
        static void WriteFile()
        {
            ...
            using (StreamWriter sw = new StreamWriter(".//usersboard//res.txt", true))
            {
        ...
        {
            Console.WriteLine("Кол-во живых клеток:  " + board.AliveCellsCount());
            Console.WriteLine("Кол-во блоков:  " + board.BlocksCount());
            Console.WriteLine("Кол-во боксов:  " + board.BoxesCount());
        }
