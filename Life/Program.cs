...
namespace LifeSimulation
{
    ...
    public class GameBoard
    {
        ...
        public GameBoard(int width, int height, int cellSize, double liveDensity)
        {
            CellSize = cellSize + 1;
        ...
        {
            var data = JsonSerializer.Deserialize<Configuration>(File.ReadAllText(filePath));
    ...
    public class LifeGame
    {
        ...
        public int InitializeBoard(string cellFilePath, string configFilePath)
        {
            ...
            _board = new GameBoard(config.Width, config.Height, config.CellSize, config.LiveDensity);
