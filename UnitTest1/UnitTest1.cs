...
namespace UnitTests
{
    ...
    public class UnitTest1
    {
        ...
        {
            Board board = new Board(5, 5, 1, 1);
            board.LoadFromFile("../../../../frigate.txt");
            Figure[] fig = Figure.GetFigure("../../../../figuretest.json");
