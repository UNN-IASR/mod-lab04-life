...
namespace cli_life
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            int num = 0;
            Set c = new Set();
            c.Conf("D:\\ConsoleApp1\\form.json");
            Reboot(c);
            c.LoadState(board, "D:\\ConsoleApp1\\data.txt");
            while ((true) && (num < 10))
            {
                num++;
                Console.Clear();
                Show();
                c.SaveState(board, "D:\\ConsoleApp1\\data.txt");
                board.Advance();
                Thread.Sleep(1000);
            }
            do
            {
                ...
                switch (choice)
                {
                    case 1:
                        num = 0;
                        c.LoadState(board, "D:\\ConsoleApp1\\1.txt");
                        while ((true) && (num < 5))
                        {
                            num++;
                            Console.Clear();
                            Show();
                            c.SaveState(board, "D:\\ConsoleApp1\\1.txt");
                            board.Advance();
                            Thread.Sleep(1000);
                        }
                        break;
                    case 2:
                        num = 0;
                        c.LoadState(board, "D:\\ConsoleApp1\\2.txt");
                        while ((true) && (num < 5))
                        {
                            num++;
                            Console.Clear();
                            Show();
                            c.SaveState(board, "D:\\ConsoleApp1\\2.txt");
                            board.Advance();
                            Thread.Sleep(1000);
                        }
                        break;
                    case 3:
                        num = 0;
                        c.LoadState(board, "D:\\ConsoleApp1\\3.txt");
                        while ((true) && (num < 5))
                        {
                            num++;
                            Console.Clear();
                            Show();
                            c.SaveState(board, "D:\\ConsoleApp1\\3.txt");
                            board.Advance();
                            Thread.Sleep(1000);
                        }
                        break;
                    case 4:
                        num = 0;
                        c.LoadState(board, "D:\\ConsoleApp1\\4.txt");
                        while ((true) && (num < 5))
                        {
                            num++;
                            Console.Clear();
                            Show();
                            c.SaveState(board, "D:\\ConsoleApp1\\4.txt");
                            board.Advance();
                            Thread.Sleep(1000);
                        }
                        break;
                    case 5:
                        num = 0;
                        c.LoadState(board, "D:\\ConsoleApp1\\5.txt");
                        while ((true) && (num < 5))
                        {
                            num++;
                            Console.Clear();
                            Show();
                            c.SaveState(board, "D:\\ConsoleApp1\\5.txt");
                            board.Advance();
                            Thread.Sleep(1000);
                        }
                        break;
