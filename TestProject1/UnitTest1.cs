...
public class UnitTest1
{
    ...
    {
        Board board = new Board(75, 75, 1, 0.1); 
        
        Assert.AreEqual(75, board.Width);
    ...
    {   
        ...
        Assert.AreEqual(50, settings.Height);
    ...
    public void TestMethod3()
    {
        ...
        board.Upload("../../../../test2.txt");
        Figure[] fig = Figure.GetFigure("../../../../testFigure.json");
        Figure block = fig[0];
